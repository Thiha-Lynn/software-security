...
(fork/clone, Docker, proxies), to scaffold this worksheet's structure, and as the subject of the
*Audit the AI* task below. All analysis, STRIDE reasoning, rankings and written answers are my own.
